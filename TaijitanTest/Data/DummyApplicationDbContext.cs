    ...
    public class DummyApplicationDbContext
    {
        ...
        public DummyApplicationDbContext()
        {
            ...
            _users = new List<User>
            {
                ...
                new Member("Martens", "Tijs", new DateTime(1999, 6, 14), "Unknown", _brussel, "Belgie", "Unknown", "0499721771", "tijs.martens@student.hogent.be"),
                new Member("Dekien", "Robbe", new DateTime(1998, 8, 26), "Garzebekeveldstraat", _gent, "Belgie", "Unknown", "0000000000", "robbe.dekien@student.hogent.be"),
                new Member("Verlinde", "Stef", new DateTime(1999, 4, 25), "Unknown", _antwerpen, "Belgie", "Unknown", "0000000000", "stef.verlinde@student.hogent.be"),
